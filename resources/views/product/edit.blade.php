                    ...
                    <form action="{{url('/products')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label for="addQty">Tambah / Kurangi Stok </label>
                                    <input type="number" class="form-control" name="addQty" value="{{ old('addQty') }}" placeholder="- untuk mengurangi stock | + menambah stock">
